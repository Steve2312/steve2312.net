    ...
    return (
        <SafeArea
            className={`flex gap-10 ${
                prismicContentWithImage.primary.content_position == 'left'
        ...
        >
            <div className="flex-1">
                <Heading level={2} type={HeadingType.HEADING} className="mb-10">
                    {prismicContentWithImage.primary.heading[0]?.text}
                </Heading>
                <BodyText
                    className="leading-8"
                    field={prismicContentWithImage.primary.content}
                />
            </div>
            <div className="flex-1">
                <img
                    src={prismicContentWithImage.primary.image.url}
